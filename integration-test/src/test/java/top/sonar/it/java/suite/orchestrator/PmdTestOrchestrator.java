 ...
 */
package top.sonar.it.java.suite.orchestrator;
...
public class PmdTestOrchestrator {
    ...
    public static PmdTestOrchestrator init() {
        final Orchestrator build = Orchestrator
                ...
                .restoreProfileAtStartup(ofClasspath("/top/sonar/it/java/PmdTest/pmd-junit-rules.xml"))
                .restoreProfileAtStartup(ofClasspath("/top/sonar/it/java/PmdTest/pmd-extensions-profile.xml"))
                .restoreProfileAtStartup(ofClasspath("/top/sonar/it/java/PmdTest/pmd-backup.xml"))
                .restoreProfileAtStartup(ofClasspath("/top/sonar/it/java/PmdTest/pmd-all-rules.xml"))
                .build();
